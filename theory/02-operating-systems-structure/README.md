...
7. [Пейджинг](#7-Paging)
8. [Управление на входно-изходните устройства (I/O Management)](#8-управление-на-входно-изходните-устройства-io-management)
9. [Управление на външно-запаметяващите устройства (Storage Management)](#9-управление-на-външно-запаметяващите-устройства-storage-management)
10. [Имплементация на защитна сигурност (Security)](#10-имплементация-на-защитна-сигурност-security)
...
## 8. Управление на входно-изходните устройства (I/O Management)
